...
$(function(){
	...
	$(".info_flight").click(function(){
	
	let Flno = $(this).find("#flno").val();

	location= "/reservation/paymentWrite.do?Flno=" + Flno + "&people=${param.people}"; 
	...
	location= "/reservation/FSView.do?Flno=" + Flno + "&people=${param.people}"; 
...
<div style ="height: 150px; width: 100%">
			...
			<div class="info_flight" style="height: 68%;">
					<div style="height: 40%; margin-top: 4px;">
						 <div class="sTime_info pull-left" style="width: 25%;height:100%;float: left;"> ${vo.sTime } </div>
						 <div id="LT_info_icon" style="width: 50%; height: 100%; float: left;"> 
						 <div class="LT_info center" style="width:100%; height: 100%;">소요시간: ${vo.leadTime } </div> 
						 </div> 
						<div class="eTime_info pull-right" style="width: 25%;float: left;"> ${vo.eTime } </div>
					</div>
					<div class="station_info" style="width: 100%;">
					<div style="width: 25%; float: left;">
						<span class="s_station pull-left"  style="text-align: left; margin-left: 110px;">${vo.startStation }</span> 
					</div>
					<div style="width: 50%; float: left;">
					<i class="fi fi-rr-arrow-alt-right" style="width: 100%"></i>
					</div>
					<div style="width: 25%; float: left;">
     				    <span class="e_station pull-right" style="text-align: right; margin-right: 110px;">${vo.endStation }</span>
					</div>
					</div>
					<input type="hidden" id="flno" name="flno" value="${vo.flightNo }">
					</div>
					<div class="detail_btn" style="height:30%; width: 100%; float: left; background: DodgerBlue; border-radius: 10px; padding-top: 10px;">
						<span class="FlightNo pull-left" style="margin-left: 110px; color: white;">항공편 번호 : ${vo.flightNo }</span> 
						<input type="hidden" id="flno" name="flno" value="${vo.flightNo }">							
